 ...
 */
class WechatNativePayment extends WechatDriver implements PaymentHandlerInterface {
	...
	public function doPay($tradeData = array())
	{
        ...
        if ($aResponse['code'] == 200) {
            return $this->retval(['code' => 200, 'data' => ['code_url' => $aResponse['data']['value']], 'msg' => 'success.']);
        } else {
