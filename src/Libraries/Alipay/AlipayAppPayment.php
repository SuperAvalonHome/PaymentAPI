 ...
 */
class AlipayAppPayment extends AlipayDriver implements PaymentHandlerInterface {
	...
	public function doPay($payParams = [])
	{
        ...
        $sRequestData = $this->tradeAppPay($payParams, $bizParams);
        
        exit(json_encode(['code' => 200, 'data' => $sRequestData]));
	}
